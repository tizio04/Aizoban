...
public class Italian_MangaEden implements Source {
    public static final String TAG = Italian_MangaEden.class.getSimpleName();

    public static final String NAME = "MangaEden (IT)";
    public static final String BASE_URL = "www.mangaeden.com";
    public static final String INITIAL_UPDATE_URL = "http://www.mangaeden.com/ajax/news/1/1";

    private NetworkService mNetworkService;
    private QueryManager mQueryManager;
    private CacheManager mCacheManager;

    public Italian_MangaEden(NetworkService networkService, QueryManager queryManager, CacheManager cacheManager) {
