...
public class English_MangaHere implements Source {
    public static final String TAG = English_MangaHere.class.getSimpleName();
    ...
    public English_MangaHere(NetworkService networkService, QueryManager queryManager, CacheManager cacheManager) {
