...
public class NavigationAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (currentView == null) {
            currentView = LayoutInflater.from(mContext).inflate(R.layout.item_list_navigation, parent, false);
        ...
        if (position == mCurrentPosition) {
            viewHolder.renderView(mContext, currentNavigationItem, mContext.getResources().getColor(R.color.accentColor), mContext.getResources().getColor(R.color.accentColor));
        } else {
            viewHolder.renderView(mContext, currentNavigationItem, mContext.getResources().getColor(R.color.secondaryText), mContext.getResources().getColor(R.color.secondaryText));
        }
    ...
    private static class ViewHolder {
        ...
        public ViewHolder(View itemView) {
            mIconImageView = (ImageView)itemView.findViewById(R.id.navigationItemIconImageView);
            mTitleTextView = (TextView)itemView.findViewById(R.id.navigationItemTitleTextView);
        }
