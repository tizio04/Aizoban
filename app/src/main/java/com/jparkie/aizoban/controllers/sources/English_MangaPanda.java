...
public class English_MangaPanda implements Source {
    public static final String NAME = "MangaPanda (EN)";
    public static final String BASE_URL = "http://www.mangapanda.com/";

    private static final String INITIAL_UPDATE_URL = "http://www.mangapanda.com/latest/";
    ...
    private Manga constructMangaFromHtmlBlock(Element htmlBlock) {
        ...
        if (urlElement != null) {
            String fieldUrl = "http://www.mangapanda.com" + urlElement.attr("href");
    ...
    private List<String> parseHtmlToPageUrls(String unparsedHtml) {
        ...
        for (Element pageUrlElement : pageUrlElements) {
            pageUrlList.add("http://www.mangapanda.com" + pageUrlElement.attr("value"));
        }
    ...
    private static String INITIAL_DATABASE_URL = "http://www.mangapanda.com/popular";
    ...
    public Observable<String> recursivelyConstructDatabase(final String url) {
        return MangaService.getPermanentInstance()
                ...
                .flatMap(new Func1<String, Observable<String>>() {
                    @Override
                    public Observable<String> call(String unparsedHtml) {
                        return Observable.just(parseEnglish_MangaPanda(unparsedHtml));
                    }
                });
    }
    ...
    private String parseEnglish_MangaPanda(String unparsedHtml) {
        Document parsedDocument = Jsoup.parse(unparsedHtml);
        ...
        for (Element mangaElement : mangaElements) {
            ...
            String fieldUrl = "http://www.mangapanda.com" + temporaryElementOne.attr("href");
        ...
        Element nextUrlElement = parsedDocument.select("div#sp").select("a:containsOwn(>)").first();
        if (nextUrlElement != null) {
            return "http://www.mangapanda.com" + nextUrlElement.attr("href");
        }
